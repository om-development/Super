...
const HomeDropdown = () => (
  <div className="grid grid-cols-2 gap-3">
    <a href="/notfound" className="rounded-lg p-3 transition-colors hover:bg-gray-50">
...
const FindJobsDropdown = () => (
  <div>
    ...
    <Link to="/job" className="ml-auto mt-2 flex items-center gap-1 text-base font-medium text-blue-600">
